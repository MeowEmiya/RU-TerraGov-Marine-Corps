...
/datum/keybinding/xeno/shattering_charge
	name = "shattering_charge"
	full_name = "Bull: Shattering Charge"
	description = "A charge that breaks items in victim hands."
	keybind_signal = COMSIG_XENOABILITY_BULLSHATTER
	hotkey_keys = list("F")
